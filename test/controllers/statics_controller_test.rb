...
class StaticsControllerTest < ActionController::TestCase
  ...
  test "should create static" do
    assert_difference('Static.count') do
      post :create, static: { body: @static.body, short_url: @static.short_url, template: @static.template, title: @static.title }
    end
  ...
  test "should update static" do
    patch :update, id: @static, static: { body: @static.body, short_url: @static.short_url, template: @static.template, title: @static.title }
    assert_redirected_to static_path(assigns(:static))
  end
